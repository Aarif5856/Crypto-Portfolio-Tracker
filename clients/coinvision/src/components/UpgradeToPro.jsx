    ...
    <div className="card gradient-bg text-white">
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold">{appConfig.monetization.proPrice}</div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button 
          ...
          className="flex-1 bg-white text-primary-600 hover:bg-gray-100 font-medium py-3 px-4 rounded-lg transition-colors duration-200"
        >
          Start Free Trial
        </button>
        <button 
          onClick={() => setIsModalOpen(true)}
          className="flex-1 bg-white/20 hover:bg-white/30 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200"
        >
          Learn More
        </button>
      </div>
