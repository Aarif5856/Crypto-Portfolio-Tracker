      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={onClose}
              className="w-full text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 font-medium py-2 px-4 rounded-lg transition-colors duration-200"
            >
              Maybe Later
            </button>
          </div>
          ...
          {/* Terms */}
          <div className="text-xs text-gray-600 dark:text-gray-400 text-center mt-4">
